...
export default function Navbar(props) {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark" id='navigationBar'>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    </form>:<button className='btn btn-outline-primary mx-2' onClick={handleLogOut} role='button'>Logout</button>}
                </div>
            </div>
        </nav>
    )
